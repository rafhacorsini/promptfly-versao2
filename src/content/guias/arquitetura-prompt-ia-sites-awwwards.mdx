...
<Checklist data='[
  { "label": "Qual o easing?", "desc": "Defini power2.out, expo.out ou linear explicitamente?" },
  { "label": "O movimento tem peso?", "desc": "Durações longas o bastante, acima de 1.2s, para dar drama?" },
  { "label": "Onde está a tensão visual?", "desc": "Ordenei quebra de simetria com position absolute em vez de aceitar centralização?" },
  { "label": "Como a luz se comporta?", "desc": "Especifiquei blurs, blends, reflexos internos?" },
  { "label": "A fonte é fluida?", "desc": "Troquei px fixos por clamp e vw?" },
  { "label": "Existe motor físico?", "desc": "Atrelei a rolagem ao Lenis com scrub no GSAP?" }
]' />
