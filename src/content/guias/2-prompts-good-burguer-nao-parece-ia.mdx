...
Antes de colar: esses prompts são uma amostra do que eu uso em todo projeto. No **Promptfly Premium** tem os templates completos, os prompts documentados de cada site e as skills — tudo isso pronto, sem precisar reconstruir do zero. → **[Ver o que tem lá](https://promptfly.com.br/premium)**
