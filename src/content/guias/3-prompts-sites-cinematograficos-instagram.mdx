...
description: "Animação de texto, transição entre seções e entrada de seção. Os 3 prompts completos que transformam um site genérico em algo com cara de estúdio — especificando cada easing, duração e movimento. Cole no Claude Code e veja a diferença."
date: "2026-06-30"
...
Abaixo, os 3 prompts **completos** — com cada parâmetro especificado pra você só copiar, colar no Claude Code e ver funcionando.
