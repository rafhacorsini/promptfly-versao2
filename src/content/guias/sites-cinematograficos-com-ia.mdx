...
> **Nota sobre fontes:** O projeto usa Neue Haas Grot Display (versão trial). Se você não tiver os arquivos `.otf`, o sistema cai para Helvetica Neue como fallback — o layout aguenta.
