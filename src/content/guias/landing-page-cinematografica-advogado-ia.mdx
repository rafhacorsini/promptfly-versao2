...
<video autoPlay muted loop playsInline style={{width: "100%", borderRadius: "12px", margin: "2rem 0", border: "1px solid rgba(0,0,0,0.08)"}}>
  <source src="/prints/landing-advogado-preview.mp4" type="video/mp4" />
</video>
...
Usa o **Gemini 2.5 Pro** (versão High, não a gratuita). Ele é o único que consegue gerar código complexo de animação sem travar no meio do caminho.

Se aparecer algum erro no site, abre o **Claude** e cola o erro lá. O Claude é muito melhor para corrigir coisas específicas e custa muito menos do que usar o Gemini para tudo. Essa combinação economiza uns 70% dos seus créditos.
