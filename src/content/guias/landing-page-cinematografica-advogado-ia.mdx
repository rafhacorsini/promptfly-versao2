...
Usa o **Gemini 2.5 Flash High** (o modelo mais novo, não a versão gratuita). Ele é o único que consegue gerar código complexo de animação sem travar no meio do caminho.
